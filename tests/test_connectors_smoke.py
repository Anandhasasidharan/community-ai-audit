...
class _FakeRequestsModule:
    ...
    def __init__(self, resp_queue=None):
        ...
        self.Session = lambda: _FakeSession(
            self._resp_queue
        )  # return a factory that captures resp_queue
...
class TestConnectorsSmoke(unittest.TestCase):
    def test_splunk_connect_and_send_batch_success(self):
        ...
        with patch(
            "community_ai_audit.connectors.splunk_connector.requests",
            _FakeRequestsModule(
                [
    ...
    def test_splunk_retry_on_5xx(self):
        ...
        resp_queue = [
            ...
            _FakeResp(503),
            _FakeResp(503),
            _FakeResp(200, {"acknowledged": 2}),
        ]
        c = SplunkConnector()
        with patch(
            "community_ai_audit.connectors.splunk_connector.requests.Session"
    ...
    def test_datadog_retry_on_429_then_success(self):
        ...
        c = DatadogConnector()
        with (
            patch("community_ai_audit.connectors.datadog_connector.requests.post") as mock_post,
    ...
    def test_sentinel_retry_on_timeout_then_success(self):
        ...
        with (
            patch("community_ai_audit.connectors.sentinel_connector.requests.post") as mock_post,
